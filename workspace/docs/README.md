...
> 测试代码与原始数据：`/root/workspace/benchmark/05-ai-dl/`
> （`run_bench.py` + `xpu_bench/` 13 个 suite、`diagnostics/` 7 个定向探针、`results/` 原始 JSON/MD）
...
| [`TODO/02-compute-peak.md`](./TODO/02-compute-peak.md) | 算力峰值测试（FP32 / FP64 / INT / XMX） |
| [`TODO/03-memory-bandwidth.md`](./TODO/03-memory-bandwidth.md) | 显存带宽测试（HBM） |
| [`TODO/04-interconnect-xelink.md`](./TODO/04-interconnect-xelink.md) | 互连测试（Xe Link / GPU-aware MPI / oneCCL） |
